...
@Profile(ConfigurationProfiles.DEVELOPMENT)
@PropertySource({ "classpath:ne-api-dev.properties", "classpath:mysql-db-dev.properties" })
@Configuration
public class DevProfilePropertiesConfiguration {
